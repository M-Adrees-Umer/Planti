...
class TomatoLeaf extends StatefulWidget {
  const TomatoLeaf({Key? key}) : super(key: key);

  @override
  _TomatoLeafState createState() => _TomatoLeafState();
}

class _TomatoLeafState extends State<TomatoLeaf> {
  XFile? image;
  bool isLoading = true;
  List? _outputs;
